...
function App() {
  return (
    <div className="dec">
      ...
      <div>
       <svg>
         <path d="M120 20 l60 60 l-120 0 Z" stroke="red" strokeWidth="2px" fill="white"/>
         <path d="M1,1 l0.1 0.1 l0.1 0.1 l0.1 0.1 l10 10" stroke="red" strokeWidth="2px" fill="white"/>
         <path d="M50 50 q 30 30 50 50" stroke="red" strokeWidth="2px" fill="white"/>
       </svg>
      </div>  
    </div>
  );
