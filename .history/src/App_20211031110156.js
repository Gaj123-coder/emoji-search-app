...
function App() {
  ...
  return (
    <div className="dec">
      <button type="submit" id="recent" onClick={emotionSelector} className="dec-child">
        <svg>
      ...
      <button id="smile" onClick={emotionSelector} className="dec-child">
        <svg>
      ...
      <button id="hand" onClick={emotionSelector} className="dec-child">
        <p style={{fontSize:"20px"}}>&#129306;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button id="gift" className="dec-child" onClick={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#127873;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button id="sports" className="dec-child" onClick={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#9917;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button id="animal" className="dec-child" onClick={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#128041;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
    </div>
