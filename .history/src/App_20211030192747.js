...
function App() {
  return (
    <div className="dec">
      ...
      <div>
       <svg>
         <path d="M120 20 l60 60 l-120 0 Z" stroke="black" strokeWidth="2px" fill="white"/>
         <path d="M1,1 l0.1 0.1 l0.1 0.1 l0.1 0.1 l10 10" stroke="black" strokeWidth="2px" fill="none"/>
         <path d="M0 0 C1 1 300 400" stroke="red" strokeWidth="3" fill="none"/>
         <path d="M0 9 C1 1 100 100" stroke="red" strokeWidth="3" fill="none"/>
       </svg>
      </div>  
    </div>
  );
