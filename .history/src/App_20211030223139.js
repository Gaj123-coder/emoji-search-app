...
function App() {
  return (
    <div className="dec">
      <div id="recent" className="dec-child">
        <svg>
        ...
        <hr style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}></hr>
      </div>
      <div id="smile" className="dec-child">
        <svg>
      ...
      <div id="hand" className="dec-child">
        <p style={{fontSize:"20px"}}>&#129306;</p>
        <hr sytle={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="gift" className="dec-child">
        <p style={{fontSize:"20px"}}>&#127873;</p>
        <hr style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="sports" className="dec-child">
        <p style={{fontSize:"20px"}}>&#9917;</p>
        <hr style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="animal" className="dec-child">
        <p style={{fontSize:"20px"}}>&#128041;</p>
        <hrs style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
    </div>
  );
}
