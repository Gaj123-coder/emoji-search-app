...
function App() {
  return (
    <div className="dec">
      ...
      <div>
        <svg>
          <polygon points="100,10 10,100 0,0 100,0" stroke="grey" strokeWidth="1px" fill="orange"/>
          <polygon points="0,0 10,10 23,23 45,145" stroke="grey" strokweWidth="1px" fill="yellow"/>
          <polygon points="0,110 100,10 23,314, 45,56 1,1 20,210" stroke="grey" strokeWidth="1px" fill="skyblue"/>
          <polygon points="0,110 100,10 23,314 45,56 1,1 20,110" stroke="grey" strokeWidth="1px" fill="skyblue"/>
        </svg>
      </div>  
    </div>
  );
