...
function App() {
  ...
  return (
    <div className="dec">
      <div id="recent" onClick={emotionSelector} className="dec-child">
        <svg onClick={emotionSelector}>
      ...
      <div id="smile" onClick={emotionSelector} className="dec-child">
        <svg>
      ...
      <div id="hand" onClick={emotionSelector} className="dec-child">
        <p onClick={emotionSelector} style={{fontSize:"20px"}}>&#129306;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="gift" className="dec-child" onClick={emotionSelector}>
        <p onClick={emotionSelector} style={{fontSize:"20px"}}>&#127873;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="sports" className="dec-child" onClick={emotionSelector}>
        <p onClick={emotionSelector} style={{fontSize:"20px"}}>&#9917;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
      <div id="animal" className="dec-child" onClick={emotionSelector}>
        <p onClick={emotionSelector} style={{fontSize:"20px"}}>&#128041;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </div>
    </div>
