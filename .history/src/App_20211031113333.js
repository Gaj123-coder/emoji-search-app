...
function App() {
  ...
  return (
    <form className="dec">
      <button type="submit" id="recent" className="dec-child" onSubmit={emotionSelector}>
        <svg>
      ...
      <button type="submit" id="smile"  className="dec-child" onSubmit={emotionSelector}>
        <svg>
      ...
      <button type="submit" id="hand" className="dec-child" onSubmit={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#129306;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button type="submit" id="gift" className="dec-child" onSubmit={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#127873;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button type="submit" id="sports" className="dec-child" onSubmit={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#9917;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
      <button type="submit" id="animal" className="dec-child" onSubmit={emotionSelector}>
        <p style={{fontSize:"20px"}}>&#128041;</p>
        <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"rgb(14, 211, 162)"}}/>
      </button>
    </form>
