    ...
    <React.Fragment>
      <form className="dec">
        <button type="submit" id="recent1" className="dec-child" onClick={emotionSelector}>
          ...
          <hr className="cir-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"recent1"===emotion?"rgb(14, 211, 162)":"white"}}></hr>
        </button>
        <button type="submit" id="smiley1"  className="dec-child" onClick={emotionSelector}>
          ...
          <hr  className="smil-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"smiley1"===emotion?"rgb(14, 211, 162)":"white"}}></hr>
        </button>
        <button type="submit" id="hands1" className="dec-child" onClick={emotionSelector}>
          <p style={{fontSize:"20px"}}>&#129306;</p>
          <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"hands1"===emotion?"rgb(14, 211, 162)":"white"}}/>
        </button>
        <button type="submit" id="gift1" className="dec-child" onClick={emotionSelector}>
          <p style={{fontSize:"20px"}}>&#127873;</p>
          <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"gift1"===emotion?"rgb(14, 211, 162)":"white"}}/>
        </button>
        <button type="submit" id="sports1" className="dec-child" onClick={emotionSelector}>
          <p style={{fontSize:"20px"}}>&#9917;</p>
          <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"sports1"===emotion?"rgb(14, 211, 162)":"white"}}/>
        </button>
        <button type="submit" id="animals1" className="dec-child" onClick={emotionSelector}>
          <p style={{fontSize:"20px"}}>&#128041;</p>
          <hr className="rem-pos" style={{width:"50px",borderRadius:"200px",height:"2px",backgroundColor:"animals1"===emotion?"rgb(14, 211, 162)":"white"}}/>
        </button>
      </form>
      <Res emotion={emotion}/>
    </React.Fragment>
