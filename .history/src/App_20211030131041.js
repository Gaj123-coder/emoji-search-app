    ...
    <div className="dec">
      <div>
        <svg>
          ...
          <rect x="20" y="8" width="1px" height="8px" stroke="grey" strokeWidth="0.5px" fill="rgb(218, 214, 214)"/>
          <rect x="20" y="15" width="8px" height="1px" stroke="grey" strokeWidth="0.5px" fill="rgb(218, 214, 214)"/>
